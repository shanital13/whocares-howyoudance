...
export const mockClasses: DanceClass[] = [
  {
    ...
    level: 'all',
    description: 'שיעור לכל הרמות — תנועה חופשית ושחרור דרך הגוף',
  ...
  },
  {
    ...
    name: 'ריקוד חופשי',
    level: 'beginner',
    description: 'שיעור למתחילות — בואו לגלות את הריקוד שבכן',
  ...
  },
  {
    ...
    name: 'תנועה אותנטית',
    level: 'intermediate',
    description: 'העמקה בתנועה אותנטית וחיבור לגוף',
    location: 'סטודיו חיפה, רח\' הנמל 12',
    date: '2026-03-15',
    time: '10:00',
    is_recurring: false,
  ...
  },
  {
    ...
    name: 'ריקוד אקסטטי',
    level: 'advanced',
    description: 'חוויית ריקוד אינטנסיבית על חוף הים',
