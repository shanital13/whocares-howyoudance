...
const DEFAULTS = {
  ...
  who_am_i_paragraph_2: '\nאני אגלה לכן סוד קטן, אנחנו לא הולכים להופיע בפסטיבל כרמיאל ולא לתת פייט ללהקת בת שבע 😊\n',
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.h2
          ...
          className="text-4xl md:text-5xl lg:text-6xl text-white mb-12 md:mb-16 text-center drop-shadow-lg"
        >
          {t('who_am_i_title')}
        </motion.h2>
