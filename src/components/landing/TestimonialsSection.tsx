...
const testimonials = [
  {
    quote: 'כבחורה מלאה תמיד לכל מקום שאני נכנסת אני ישר מרגישה איך אני "תופסת מקום" ואיתך בשיעורים איכשהו פעם ראשונה שלא הרגשתי את זה - תודה על זה .',
    name: 'אוראל',
    role: '​',
    bg: 'bg-hoodie-orange',
  },
  {
    quote: 'תודה על ההומור,התנועה והמוזיקה הישראלית ובכלל על כל מה שאתה מביא לחיים שלנו, מרגש ולא מובן מאליו.',
    name: 'שירה',
    role: '​',
    bg: 'bg-hoodie-yellow',
  },
  {
    quote: 'האנרגיה, האהבה, הקלילות — הכל שם. ממליצה לכל אישה לבוא ולחוות את הקסם.',
    name: 'שירה',
    role: '​',
    bg: 'bg-hoodie-teal',
  },
